...
/*
    Two teams play a basketball match.

    Given the list of <player, team, points> for each player in the match,
    we have to get the match scoreboard with only one line of code.
 */
enum class Team {
    YELLOW, BLUE
}
